...
from data_services import load_all_records, load_person_records, prepare_records_dataframe
...
all_df = prepare_records_dataframe(all_records)
...
render_group_payment_summary(all_df, logger)
